            ...
            <form action="{{ route('admin.setting.update') }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    @if (old('image'))
                        ...
                        <img class="mt-2" id="image_preview" height="100" src="{{ asset(old('image')) }}" />
                    @elseif (isset($config) && isset($config['logo']))
                        <input type="hidden" name="image" value="{{ $config['logo']->value }}" id="image">
                        <img class="mt-2" id="image_preview" height="100" src="{{ asset($config['logo']->value) }}" />
                    @else
                ...
                {{-- <div class="form-group">
                    ...
                    @elseif(isset($config['hotline']))
                        <input class="form-control" id="about_title" name="about_title"
                            value="{{ $config['about_title']->value }}">
                    @else
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="facebook" name="facebook"
                        value="{{ old('facebook') ?? $config['facebook']->value }}">
                </div>
                <div class="form-group">
                    <label class="font-weight-semibold">Instagram </label>
                    <input type="text" class="form-control" id="instagram" name="instagram"
                        value="{{ old('instagram') ?? $config['instagram']->value }}">
                </div>
                <div class="form-group">
                    <label class="font-weight-semibold">Youtube </label>
                    <input type="text" class="form-control" id="youtube" name="youtube"
                        value="{{ old('youtube') ?? $config['youtube']->value }}">
                </div>
                <div class="form-group">
                    <label class="font-weight-semibold">Google map </label>
                    <input type="text" class="form-control" id="map" name="map"
                        value="{{ old('map') ?? $config['map']->value }}">
                </div>
