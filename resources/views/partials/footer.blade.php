                    ...
                    <div class="row">
                        ...
                        <div class="footer-column col-xl-3 col-lg-3 col-md-6 col-sm-12">
                            <div class="footer-widget">
                                ...
                                <ul class="user-links">
                                    <li><a href="#">{{ __('footer.service_content_1') }}</a></li>
                                    <li><a href="#">{{ __('footer.service_content_2') }}</a></li>
                                    <li><a href="#">{{ __('footer.service_content_3') }}</a></li>
                                    <li><a href="#">{{ __('footer.service_content_4') }}</a></li>
                                    <li><a href="#">{{ __('footer.service_content_5') }}</a></li>
                                </ul>
                            </div>
                        </div>
