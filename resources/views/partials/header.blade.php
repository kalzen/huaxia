<header class="main-header header-style-one">
            ...
            <div class="header-lower">
                ...
                <div class="main-box">
                    <div class="logo-box">
                        <div class="logo">
                            <a href="{{route('home')}}"><img src="{{asset('huaxia/images/logo.jpg')}}" alt title="Huaxia" /></a>
                        </div>
                    </div>
            ...
            <div class="mobile-menu">
                ...
                <nav class="menu-box">
                    <div class="upper-box">
                        <div class="nav-logo">
                            <a href="{{route('home')}}"><img src="{{asset('huaxia/images/logo-navi.jpg')}}" alt title="Huaxia" /></a>
                        </div>
            ...
            <div class="sticky-header">
                <div class="auto-container">
                    <div class="inner-container">
                        ...
                        <div class="logo">
                            <a href="{{route('home')}}" title><img src="{{asset('huaxia/images/logo-navi.png')}}" alt title /></a>
                        </div>
